...
MDNSResponder mdns;
const char* ssid = "FACULTY"; // your connection name
const char* password = "@ce$$@F@culty"; // your connection password
...
content += "<br><p><marquee direction='right'>Developed by Shivam Maheshwari & Shivangee Singh </marquee></p>";
